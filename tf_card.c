...
#define FCLK_FAST() { SPI_CTL0(SPI1) = (SPI_CTL0(SPI1) & ~0x38) | 0x10; }	/* Set SCLK = PCLK2 / 2 */

// #define FCLK_SLOW()
// #define FCLK_FAST()

//#define CS_HIGH() PB_OUT(4,1)
#define CS_HIGH() gpio_bit_set(GPIOC, GPIO_PIN_14)
//#define CS_LOW() PB_OUT(4,0)
#define CS_LOW() gpio_bit_reset(GPIOC, GPIO_PIN_14)
